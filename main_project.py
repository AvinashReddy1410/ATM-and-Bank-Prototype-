...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.configure(background="#8EE5EE")
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#000000", background="#8EE5EE", disabledforeground="#a3a3a3",
...
class adminLogin:
    def __init__(self, window=None):
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#E6E6FA",
                                foreground="#00254a",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#E6E6FA",
                                     foreground="#00254a",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="#001c37", text="Select your option", background="#FFE4B5")
        ...
        global Frame1
        Frame1 = tk.Frame(window, relief='groove', borderwidth="2", background="#98F5FF")
...
class deleteAdmin:
    ...
    def delete_admin(self, admin_id, password):
        if admin_id == "avi" or admin_id == admin_idNO:
            Error(Toplevel(self.master))
